...
//            = new AssetDescriptor<Texture> ("atlas/Madame/madame_rotation_soupcon.png",Texture.class);
    ...
    public static final AssetDescriptor<Texture> FOREGROUND_LV1 = new AssetDescriptor<Texture>("image/comptoir.png", Texture.class);

    public static final AssetDescriptor<Texture> FOREGROUND_LV2 = new AssetDescriptor<Texture>("image/foreground_lvl2.png", Texture.class);

    public static final AssetDescriptor<Texture> FOREGROUND_LV3 = new AssetDescriptor<Texture>("image/background_lvl3_foreground.png", Texture.class);
