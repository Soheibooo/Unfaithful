...
public class EndScreen implements Screen {
    ...
    public EndScreen(Unfaithful game, boolean win) {
        this.game = game;

        if (win) {
            this.atlas = Assets.getInstance().manager.get(Assets.ATLAS_GAME_WIN);
        }
        else {
            this.atlas = Assets.getInstance().manager.get(Assets.ATLAS_GAME_OVER);
        }
