...
//		TextureLayer exemple = new TextureLayer (
//			  Assets.getInstance ().manager.get (Assets.TEXTURE_NAME));
//		exemple.setDrawingBounds (background.CAMERA_ORIGIN.x, 0, 100, 100);
//		background.addLayer (exemple);
