...
public class GameScreen implements Screen {
	...
	private void addProgressBar () {
		String[] suspiciousRegionsBackground = new
			  String[]{"suspicion_bar0000",
		                                                    "suspicion_bar0001",
		                                                    "suspicion_bar0002",
		                                                    "suspicion_bar0003",
		                                                    "suspicion_bar0004",
		...
		String[] suspiciousRegionsForeground = new String[]{
			  "suspicion_bar_progress0006", "suspicion_bar_progress0007",
			  "suspicion_bar_progress0008", "suspicion_bar_progress0015",
			  "suspicion_bar_progress0016", "suspicion_bar_progress0017",
			  "suspicion_bar_progress0018", "suspicion_bar_progress0009",
			  "suspicion_bar_progress0000", "suspicion_bar_progress0001",
			  "suspicion_bar_progress0002", "suspicion_bar_progress0010",
			  "suspicion_bar_progress0011", "suspicion_bar_progress0012",
			  "suspicion_bar_progress0003", "suspicion_bar_progress0004",
			  "suspicion_bar_progress0005", "suspicion_bar_progress0013",
		...
		String[] hackingRegionsForeground = new String[]{
			  "hacking_bar_progress0000", "hacking_bar_progress0001",
			  "hacking_bar_progress0002", "hacking_bar_progress0003",
			  "hacking_bar_progress0004", "hacking_bar_progress0005",
			  "hacking_bar_progress0006", "hacking_bar_progress0007",
			  "hacking_bar_progress0008", "hacking_bar_progress0009"};
		...
		AnimatedProgressBar suspiciousBar = new AnimatedProgressBar (0, 100, 1,
		                                                             false,
		                                                             progressBarStyle);
		suspiciousBar.setAnimationBackground (Assets.getInstance ().manager
			                                        .get (Assets
				                                                .ATLAS_BAR_SUSPICIOUS_HACKING),
		                                      suspiciousRegionsBackground,
		                                      0.1f);
		suspiciousBar.setAnimationForeground (Assets.getInstance ().manager
			                                        .get (Assets
				                                                .ATLAS_BAR_SUSPICIOUS_HACKING),
		                                      suspiciousRegionsForeground,
		                                      0.1f);
		...
		TextureRegionDrawable drawable2 = new TextureRegionDrawable (
			  new TextureRegion (new Texture (pixmap2)));
		pixmap2.dispose ();
		ProgressBar.ProgressBarStyle progressBarStyle2
			  = new ProgressBar.ProgressBarStyle ();
		progressBarStyle2.background = drawable2;

		AnimatedProgressBar hackingBar = new AnimatedProgressBar (0, 100, 2,
		                                                          false,
		                                                          progressBarStyle2);
		hackingBar.setAnimationBackground (Assets.getInstance ().manager
			                                     .get (Assets
				                                             .ATLAS_BAR_SUSPICIOUS_HACKING),
		                                   hackingRegionsBackground, 0.1f);
		hackingBar.setAnimationForeground (Assets.getInstance ().manager
			                                     .get (Assets
				                                             .ATLAS_BAR_SUSPICIOUS_HACKING),
		                                   hackingRegionsForeground, 0.1f);
	...
	private void addMenuButtons () {
		...
		TextureAtlas.AtlasRegion defaultRegion = Assets.getInstance ().manager
			  .get (Assets.ATLAS_MENU).findRegion ("menu_bar0000");
		Sprite defaultSprite = new Sprite (defaultRegion);
		String[] regions = new String[]{"menu_bar_select0000",
		                                "menu_bar_select0001",
		                                "menu_bar_select0002",
		                                "menu_bar_select0003"};

		AnimatedTextButton playButton = new AnimatedTextButton ("Play",
		                                                        textButtonStyle,
		                                                        defaultSprite);
		playButton.setAnimation (
			  Assets.getInstance ().manager.get (Assets.ATLAS_MENU), regions,
			  0.25f);
		...
		playButton = new AnimatedTextButton ("Quit", textButtonStyle,
		                                     defaultSprite);
		playButton.setAnimation (
			  Assets.getInstance ().manager.get (Assets.ATLAS_MENU), regions,
			  0.25f);
